<template>
  <div class="top_view">
    ...
    <div class="projectTitle">档案管理系统</div>
      ...
      <el-dropdown class="avatar-container right-menu-item" trigger="hover">
        ...
        <template #dropdown>
          <el-dropdown-menu slot="dropdown">
            ...
            <el-dropdown-item v-if="roleName != '超级管理员'">
...
const getSession = () => {
  context
    ...
    .then((res) => {
      ...
      if (context?.$toolUtil.storageGet('sessionTable') == 'guanlizhe') {
        context?.$toolUtil.storageSet(
          'adminHeadportrait',
          res.data.data.touxiang
        )
...
.top_view {
  ...
  background: linear-gradient(
    0deg,
    rgba(255, 154, 2, 1) 0%,
    rgba(254, 205, 115, 1) 75%,
    rgba(255, 220, 148, 1) 75%,
    rgba(252, 219, 151, 1) 100%
  );
  width: 100%;
