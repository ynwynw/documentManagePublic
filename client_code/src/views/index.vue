<template>
  <div class="home">
    <div class="index_top">
      <div class="index_top_title">档案管理系统</div>
...
const getSession = () => {
  context
    ...
    .then((res) => {
      ...
      if (context?.$toolUtil.storageGet('frontSessionTable') == 'guanlizhe') {
        context?.$toolUtil.storageSet(
          'frontName',
          res.data.data.guanliyuanzhanghao
        )
      }
      if (context?.$toolUtil.storageGet('frontSessionTable') == 'guanlizhe') {
        context?.$toolUtil.storageSet('headportrait', res.data.data.touxiang)
...
.rotation_view {
  ...
  margin: 100px auto 0;
  background: url(http://localhost:8080/documentManage/file/20f56bb671bf4d69adccda4ae75cd79f.jpg)
...
.contain_view {
  margin: 0;
  background: url(http://localhost:8080/documentManage/file/35242e5664184ac7a4048c545ad1a089.jpg);
  position: inherit;
  height: 100vh;
}
.el-aside {
...
.menu_view {
  ...
  :deep(.is-active) {
    color: #fff !important;
    background: url(http://localhost:8080/documentManage/file/326bf478d36b42e185b4729b58c4c601.png)
